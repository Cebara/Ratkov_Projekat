...
//   }
    ...
    /**
     * <b>[Method]</b> -Get Report Path map.<br>
     * <br>
     * <i>Method functionality:</i><br>
     * This method is used for to get paths for reporting
     * i.e. you can get archive folder path or source path
     *
     * @return map of report paths
     */
    ...
    public static void logInfoDetails(String log) {
        ExtentApiListener.extentTest.get().info(MarkupHelper.createLabel(log, ExtentColor.BLUE));
    }
    ...
    public static void logPassDetails(String log) {
        ExtentApiListener.extentTest.get().pass(MarkupHelper.createLabel(log, ExtentColor.GREEN));
    }
    ...
    public static void logFailureDetails(String log) {
        ExtentApiListener.extentTest.get().fail(MarkupHelper.createLabel(log, ExtentColor.RED));
    }
    ...
    public static void logExceptionDetails(String log) {
        ExtentApiListener.extentTest.get().fail(log);
    }
    ...
    public static void logInfoDetailsWithoutLabelColor(String log) {
        ExtentApiListener.extentTest.get().info(log);
    }
    ...
    public static void logHeaders(List<Header> headersList) {
        String[][] arrayHeaders = headersList.stream().map(header -> new String[]{header.getName(), header.getValue()})
                .toArray(String[][]::new);
        ExtentApiListener.extentTest.get().info(MarkupHelper.createTable(arrayHeaders));
    }
    ...
    public static void logJSON(String json) {
        ExtentApiListener.extentTest.get().info(MarkupHelper.createCodeBlock(json, CodeLanguage.JSON));
    }
