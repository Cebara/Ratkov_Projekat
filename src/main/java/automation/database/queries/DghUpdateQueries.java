...
public class DghUpdateQueries {
    ...
    public static String updateCustomerGroup(int custId, int groupId) {
    ...
    public static String executeActivateProcedure(int contract) {
        String response = "EXECUTE PROCEDURE DGH_PLM_ACTIVATE_PRODUCT_AT_WOT(" + contract + ",'AZ',current_date)";
        return response;
    }

    public static String updateContract(int custId) {
        String response = "update CONTRACTS set \n" +
                "DATE_ACTIVE = current_date, DATE_BOUND_UNTIL = current_date+730, DGH_START_OF_CONTRACT = current_date, DGH_CANCELATIONPERIOD = 1\n" +
    ...
    public static String updateCustAddEmailValidation(int custId, int addType) {
        String response = "UPDATE CUSTOMER_ADDRESSES SET dgh_email_valid = 2\n" +
    ...
    public static String activatePhone(int subsId, int phone) {
        String response = "UPDATE SUBSCRIBER SET date_active = current_date, subscriber_id = '+49 211 " + phone + "', \n" +
                "status_id = 200, dgh_type_id = 100, dgh_status_id = 30\n" +
