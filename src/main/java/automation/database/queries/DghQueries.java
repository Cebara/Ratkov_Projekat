...
public class DghQueries {
    ...
    public static String getSubscriber(int customerId) {
        String response = "SELECT s.SUBS_ID, s.STATUS_ID, s.* \n" +
                ...
                "WHERE c.CUSTOMER_ID = " + customerId + " AND s.DGH_TYPE_ID = 100";
        return response;
    }

    public static String getSubscriberForUpdatint(int customerId) {
    ...
    public static String getCoVoiceProducts(int custId) {
        String response = "SELECT cvp.COV_PRODUCT_ID, cvp.*\n" +
